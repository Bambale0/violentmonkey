...
.cockpit {
    ...
    this.cockpit = _({
      ...
      children: [
          ...
          children: [
            {
              ...
              children: [
                {
                  tag: 'input',
                  attr: { type: 'radio', name: 'question-method', value: 'text', checked: true },
                },
                {
                  tag: 'span',
            ...
            },
            {
              ...
              children: [
                {
                  tag: 'input',
                  attr: { type: 'radio', name: 'question-method', value: 'image' },
                },
                {
                  tag: 'span',
        ...
        },
        {
          ...
          attr: { 'data-question-method': 'text' },
          children: [
            {
              children: {
                tag: 'textarea',
        ...
        {
          cls: 'question-details',
          attr: { 'data-question-method': 'image' },
          children: [
            {
              children: {
                tag: 'canvas',
  ...
  logResponse(response) {
    let item = _({ tag: 'pre', cls: 'response', html: response, append: this.communicationLog });
    // this.communicationLog.scrollTo(this.communicationLog.scrollHeight);
  },

  logRequest(request) {
    let item = _({ tag: 'pre', cls: 'request', html: request, append: this.communicationLog });
    // this.communicationLog.scrollTo(this.communicationLog.scrollHeight);
  },
...
`;
  ...
  async sendRequest(content) {
    ...
    try{
      ...
      console.error('=== ОШИБКА В sendRequest ===');
      console.error(error);
  ...
  async makeScreenshot(element) {
    ...
    const stream = await navigator.mediaDevices.getDisplayMedia({ video: true, displaySurface: 'browser' });
